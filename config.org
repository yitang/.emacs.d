...
(defun yt/jekyll--export-to-md ()
  ...
  (let* ((org-name (file-name-nondirectory (file-name-sans-extension buffer-file-name)))
	 (post-name (file-name-concat jekyll-publish-dir (concat org-name ".md"))))
...
** DONE update post name and date 
CLOSED: [2023-12-18 Mon 21:40]
:PROPERTIES:
:CREATED:  [2023-12-18 Mon 14:32]
:END:

A handy function to update the title and date in the filename and also front matter.
