...
(defun blog-publish-post ()
 ...
 contains the date."
  ...
  (cond
   ...
   (t
    ;; TODO: find `filename` variable using the yt/jekyll-find-export function.
    (let ((filename
...
(defun yt/jekyll-is-draft-p ()
  "if the file is inside of the draft directory, it is an draft.

can also implmenet as  (file-name-directory (buffer-file-name (current-buffer))) equal to jekyll-source-drafts-dir
"
...
(defun yt/jekyll-find-export ()
  "find the full paht to the exported file of the current post."
