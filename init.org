...
2. quick rush
   ...
   I shared lift with my colluge, and someimes I left at the last minutes, then what I do is call the =yt/save-git-backup= functions that commits and upload to the repo so that I can continue work at home.
