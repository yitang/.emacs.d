...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/git/org/refile.org")
              ...
              ("l" "Ledger Journal" plain (file "~/git/org/Finance/ledger_transaction_2017.org")
...
#+begin_src emacs-lisp :results silent
  ...
  (setq org-agenda-files (append (sa-find-org-file-recursively "~/git/org")
                                 (sa-find-org-file-recursively "~/git/jbarm")
...
(defun yt/org-agenda-files-set-helm ()  ;; FIXME: path broken.
    (helm :sources '(((name . "Add directories to org-agenda-files variable")
                      (candidates . ("~/git/org/" "~/git/career" "~/git/jbarm"))
...
(setq org-structure-template-alist
      (quote (("s" "#+begin_src ?\n\n#+end_src" "<src lang=\"?\">\n\n</src>")
              ...
              ("R" "#+begin_src R\n?\n#+end_src" "<src lang=R\"?\">\n\n</src>")
              ("Rg" "#+begin_src R :session :exports results :results graphics :width 400 :height 400 :file (org-babel-temp-file \"figure-\" \".png\") \n?\n#+end_src")   ;; for inline images
              ("Rgp" "#+begin_src R :session :exports results :results graphics :width 11 :height 6.5 :pointsize 14 :file (org-babel-temp-file \"figure-\" \".pdf\") \n?\n#+end_src")   ;; for high resolution figures for exporting to pdf
