...
(defun yt/sh-script-editing-keybinds ()
  (local-set-key (kbd "C-RET") 'sh-send-line-or-region-and-step)
  (local-set-key (kbd "C-c C-z") ''sh-switch-to-process-buffer)         
  )
(add-hook 'sh-mode-hook 'yt/sh-script-keybinds)
#+end_src
** auctex
...
; get mail
(setq mu4e-get-mail-command "offlineimap; mu index --maildir=~/Maildir_offlineimap/JBA"
      mu4e-html2text-command "w3m -T text/html"
      mu4e-update-interval 120
      mu4e-headers-auto-update t
      mu4e-compose-signature-auto-include t)

(setq mu4e-maildir "~/Maildir_offlineimap")
