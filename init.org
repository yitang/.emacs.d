...
(setq org-structure-template-alist
      (quote (("s" "#+begin_src ?\n\n#+end_src" "<src lang=\"?\">\n\n</src>")
              ...
              ("R" "#+begin_src R\n?\n#+end_src" "<src lang=R\"?\">\n\n</src>")
              ("Rg" "#+begin_src R :results graphics :width 800 :height 800 :file \n?\n#+end_src")
...
(setq TeX-view-program-selection '((output-pdf "evience")))
#+end_src
...
#+begin_src emacs-lisp :results silent 
(require 'python)
(setq python-shell-interpreter (expand-file-name "~/anaconda3/bin/python"))
(if (equal (system-name) "MBP")
    (setq python-shell-interpreter (expand-file-name "~/anaconda/bin/python")))
