...
I never click any buttons in the menu-bar/tool-bar, to need  the scroll-bar
tells me where I am in terms of the whole buffer, so I removed all of
them to have minimal dis
#+begin_src emacs-lisp :results silent 
(tool-bar-mode -1)
(menu-bar-mode -1)
(scroll-bar-mode -1)
...
(defun pl/helm-alive-p ()
  (if (boundp 'helm-alive-p)
    ...
    ;; (add-to-list 'golden-ratio-inhitib-functions 'pl/helm-alive-p)
